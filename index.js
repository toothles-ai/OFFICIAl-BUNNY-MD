...
const ownerNumber = ['94776845671','94760663483']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.split("𝙱𝚄𝙽𝙽𝚈-𝙼𝙳=")[1];
...
console.log("Connecting ᴏꜰꜰɪᴄɪᴀʟ ʙᴜɴɴʏ ᴍᴅ Bot.....🔥");
...
console.log('ᴏꜰꜰɪᴄɪᴀʟ ʙᴜɴɴʏ ᴍᴅ Bot connected to whatsapp ✅')
...
conn.sendMessage(conn.user.id,{ image: { url: `https://i.ibb.co/PvtyPSg8/SulaMd.jpg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("94776845671")){
if(isReact) return
m.react("🚀")
}
...
app.get("/", (req, res) => {
res.send("ᴏꜰꜰɪᴄɪᴀʟ ʙᴜɴɴʏ ᴍᴅ Bot,started✅");
});
